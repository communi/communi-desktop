...
bool TreeDelegate::isDark() const
{
    return d.dark;
}

void TreeDelegate::setDark(bool dark)
{
    d.dark = dark;
}

bool TreeDelegate::rootIsDecorated() const
{
    return d.rootIsDecorated;
}

void TreeDelegate::setRootIsDecorated(bool decorated)
{
