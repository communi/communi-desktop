...
struct ConnectionInfo
{
    ...
    IrcConnection* toConnection(QObject* parent = 0) const;
    void initConnection(IrcConnection* connection) const;
    static ConnectionInfo fromConnection(IrcConnection* connection);
