...
IrcConnection* ConnectionInfo::toConnection(QObject* parent) const
{
...
void ConnectionInfo::initConnection(IrcConnection* connection) const
{
    ...
    // TODO: connection->setViews(views);
    if (quit)
        connection->setEnabled(false);
}

ConnectionInfo ConnectionInfo::fromConnection(IrcConnection* connection)
{
    ConnectionInfo info;
    ...
    // TODO: info.views = connection->views();
